...
@section('content')
        ...
        <div class="row h-100 p-0">
                            ...
                            <div class="card justify-content-center px-4">
                                <div class="row add-slide">
                                    ...
                                    <div class="add-slide-text col-8 d-flex justify-content-center align-items-center">
                                        <p class="p-0 m-0">Añadir nueva página</p>
                                    </div>
                                </div>
            ...
            @php
                if (count($slides) > 0) {
                    ...
                    $slide_audio = '';
                    $slide_text = 'Introduce el texto aquí';
                    $slide_id = null;
                    $hasSlide = false;
            ...
            <div class="col-xlg-8 col-lg-8 p-0">
                <div class="view-slide">
                    ...
                    <div class="add-slide-btns modal-footer justify-content-evenly pb-4" style="border-top: none;">
                        @if (!$hasSlide)
                            <button type="button" class="btn save" id="add_slide" onclick="saveSlide()">Guardar</button>
                            <input type="reset" class="cancel slide-cancel btn btn-secondary" value="Cancelar">
                        @endif
                    </div>
                </div>
            </div>
    ...
    @if ($not_published)
        ...
        @component('components.delete-confirmation-modal', [
            ...
            'modalTitle' => 'Eliminar página',
            'formAction' => '/deleteSlide',
            'formInputName' => 'del_slide_id',
            'modalMessage' => '¿Estás seguro de querer eliminar?',
        ])
        @endcomponent
    @endif
@endsection
